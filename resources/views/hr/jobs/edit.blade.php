        ...
        <div style="padding: 20px;">
            <form method="POST" action="{{ route('hr.jobs.update', $job->id) }}">
                ...
                <div class="form-group" style="margin-bottom: 15px;">
                    ...
                    <textarea name="description" id="description" style="display: none;" required>{{ old('description', $job->description) }}</textarea>
                </div>
...
<script>
    ...
    const form = document.querySelector('form[action="{{ route('hr.jobs.update', $job->id) }}"]');
