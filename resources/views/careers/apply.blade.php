    ...
    <style>
        ...
        *::after {
        ...
        .form-group textarea:focus {
            outline: none;
            border-color: #148cb0;
            box-shadow: 0 0 0 3px rgba(20, 140, 176, 0.1);
        }
        ...
        .upload-zone:hover {
            border-color: #148cb0;
            background: rgba(20, 140, 176, 0.03);
        }
        ...
        .upload-zone .upload-text a {
            color: #148cb0;
            font-weight: 600;
            text-decoration: none;
        }

        .upload-zone .upload-text a:hover {
            text-decoration: underline;
        }
        ...
        .btn-submit {
            ...
            box-shadow: 0 4px 12px rgba(217, 37, 37, 0.25);
        }

        .btn-submit:hover {
            background: #b31c1c;
            transform: translateY(-1px);
            box-shadow: 0 6px 16px rgba(217, 37, 37, 0.3);
        }
        ...
        <div class="apply-layout">
            ...
            <form method="POST" action="{{ route('careers.apply.store', $job->id) }}" enctype="multipart/form-data"
                ...
                <div class="form-group">
                    ...
                    <div class="upload-zone" id="upload-zone">
                        ...
                        <div class="upload-text">
                            <a href="#" onclick="document.getElementById('cv').click(); return false;">Upload a file</a>
                            or drag and drop
                        </div>
                        <div class="upload-hint">PDF, DOC, DOCX (max 5MB)</div>
                        <input name="cv" type="file" id="cv" accept=".pdf,.doc,.docx">
                        <div id="resume-preview"></div>
                    </div>
                    @error('cv') <div class="error-feedback">{{ $message }}</div> @enderror
                </div>
                ...
                <div class="form-footer">
                    <p>By submitting this application, you agree to our <a href="#">Privacy Policy</a> and <a
                            href="#">Terms of Use</a>.</p>
                    <a href="{{ route('careers.index') }}" class="back-to"><i class="fas fa-arrow-left"></i> Back to all
                        positions</a>
                </div>
            </form>
        </div>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (uploadZone && cvInput) {
                ...
                cvInput.addEventListener('change', function () {
                    if (this.files && this.files[0]) {
                        ...
                        if (preview) {
                            ...
                            preview.innerHTML = `
                                <i class="fas fa-file-alt" style="font-size: 40px; color: #148cb0;"></i>
                                <div class="upload-text" style="color: #333; font-weight: 600;">${fileName}</div>
                                <div class="upload-hint">${fileSize} MB - <a href="#" onclick="document.getElementById('cv').click(); return false;">Change file</a></div>
                            `;
                        }
                    }
                });
                ...
                uploadZone.addEventListener('dragover', function (e) {
                    e.preventDefault();
                    this.style.borderColor = '#148cb0';
                    this.style.background = 'rgba(20,140,176,0.05)';
                });
