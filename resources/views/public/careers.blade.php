...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .top-nav .btn-nav:active { transform: translateY(0); }
        ...
        .user-welcome .welcome-text strong { color: #ffd700; }
        .logout-form button {
            background: #6c757d;
            border: none;
            cursor: pointer;
        ...
        <div class="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center space-y-6 md:space-y-0">
            ...
            <div class="space-y-2 text-left md:text-left max-w-2xl">
                <div class="flex flex-wrap items-center gap-2 font-normal text-gray-400 text-sm mb-1">
                    <a href="#" class="text-gray-400 hover:text-gray-200 no-underline hover:underline">Disclaimer</a>
                    <span class="text-gray-600">|</span>
                    <a href="#" class="text-gray-400 hover:text-gray-200 no-underline hover:underline">Terms of Use</a>
                    <span class="text-gray-600">|</span>
